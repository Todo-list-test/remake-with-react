        ...
        <div className={styles.Box}>
          <div className={styles.layer}>
            ...
            <div className={styles.snsLink}>
              <a className={styles.insta} href="#insta"><img src={insta} alt="인스타그램아이콘" /></a>
              <a className={styles.facebook} href="#facebook"><img src={facebook} alt="페이스북아이콘" /></a>
              <a className={styles.twitter} href="#twitter"><img src={twitter} alt="트위터아이콘" /></a>
            </div>
          </div>
          <ul className={styles.Info}>
            {FooterMenu.map(menu => (
              <li key={menu.id}>
                <ul>
                  <li ><h3 className={styles.title} >{menu.title}</h3></li>
                  {Lists(menu.list)}
                </ul>
              </li>
            ))}
